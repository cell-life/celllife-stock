...
<body>
 <form action="alert/createAlerts" id='create_alert' method='POST'> 
<div class="container">
    ...
    <!-- <div class="alert level detail"> -->
		...
		<option value="">Message </option>
		 <option  value="Diflucan 35 ml powder for oral suspension">Diflucan 35 ml powder for oral suspension</option>
  		 <option  value="Abacavir 60 mg 56 tablets">Abacavir 60 mg 56 tablets</option>
         <option  value="Legram 10mg/ml oral solution 240 ml">Legram 10mg/ml oral solution 240 ml</option>
		></select></p></br>
